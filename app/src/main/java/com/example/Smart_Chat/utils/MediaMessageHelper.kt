...
object MediaMessageHelper {
    ...
    fun uploadAndSendImage(
        ...
        messagesReference: com.google.firebase.firestore.CollectionReference,
        senderID: String,
    ...
    private fun sendImageMessage_OneToOne(
        ...
        val msgModel = com.example.Smart_Chat.models.MsgModel(
            senderID,
            "📷 Photo",
            Timestamp.now(),
            imageUrl,
    ...
    private fun sendImageMessage_Group(
        ...
        val msgModel = com.example.Smart_Chat.models.GroupMsgModel(
            senderID,
            senderName,
            "📷 Photo",
            Timestamp.now(),
    ...
    private fun sendImageMessage_Community(
        ...
        val msgModel = com.example.Smart_Chat.models.CommunityMsgModel(
            senderID,
            senderName,
            "📷 Photo",
            Timestamp.now(),
